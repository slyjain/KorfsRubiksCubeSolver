...
class RubiksCube1D: public RubiksCube{
    ...
    std::cout << "Rotating Front face clockwise" << std::endl;
    ...
    std::cout << "Rotating Front face anti-clockwise" << std::endl;
    rotateFace(FACE::FRONT);
    ...
    std::cout << "Rotating Front face clockwise 2 times" << std::endl;
    rotateFace(FACE::FRONT);
    ...
    std::cout << "Rotating UP face clockwise" << std::endl;
    rotateFace(FACE::UP);
    ...
    std::cout << "Rotating UP face ANTI-clockwise" << std::endl;
    rotateFace(FACE::UP);
...
RubiksCube& DPRIME() override {
    std::cout << "Rotating DOWN face Anti-clockwise" << std::endl;
...
RubiksCube& U2() override {
    std::cout << "Rotating UP face clockwise for 2 times" << std::endl;
    rotateFace(FACE::UP);
...
RubiksCube& D2() override {
    std::cout << "Rotating DOWN face 2 times clockwise" << std::endl;
    rotateFace(FACE::DOWN);
...
RubiksCube& D() override {
    std::cout << "Rotating DOWN face clockwise" << std::endl;
    rotateFace(FACE::DOWN);
...
RubiksCube& B() override {
    std::cout << "Rotating BACK face clockwise" << std::endl;
    int temp[3] = {};
...
RubiksCube& B2() override {
    std::cout << "Rotating BACK face 2 times clockwise" << std::endl;
    int temp[3] = {};
    rotateFace(FACE::BACK);
...
RubiksCube& BPRIME() override {
    std::cout << "Rotating BACK face ANTI-clockwise" << std::endl;
    int temp[3] = {};
    rotateFace(FACE::BACK);
...
RubiksCube& R() override {
    std::cout << "Rotating RIGHT face clockwise" << std::endl;
    int temp[3] = {};
...
RubiksCube& R2() override {
    std::cout << "Rotating RIGHT face clockwise 2 times" << std::endl;
    int temp[3] = {};
...
RubiksCube& RPRIME() override {
    std::cout << "Rotating RIGHT face ANTI-clockwise" << std::endl;
    int temp[3] = {};
