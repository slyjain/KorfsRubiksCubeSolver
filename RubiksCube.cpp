...
void RubiksCube::printColor(char color) {
    switch (color) {
        case 'W': std::cout << "\033[38;2;255;255;255mW "; break; // Bright White
        case 'G': std::cout << "\033[38;2;0;255;0mG "; break;     // Bright Green (Lime Green)
        case 'R': std::cout << "\033[1;31mR "; break;     // Bright Red
        case 'B': std::cout << "\033[1;34mB "; break;     // Bright Blue
        case 'O': std::cout << "\033[38;2;255;165;0mO "; break;   // Bright Orange (RGB: 255, 165, 0)
        case 'Y': std::cout << "\033[38;2;255;255;0mY "; break;   // Bright Yellow
